...
#output_pdf = '../output/STFT/all-STFT_freqFocus_10-10.pdf'  # 出力するPDFファイルのパスを指定
output_pdf = './B_Out_Rail_STFT_freqFocus_10-10.pdf'  # 出力するPDFファイルのパスを指定
...
for folder in folders_list:
    ...
    for sub_folder in sub_folders_list:
        ...
        png_files.extend([folder_path + f for f in os.listdir(folder_path) if f.endswith('_STFT_10-10.png')])
