...
writeFile = writeFilePass + "_repData_v2" + split_readFile[0][2] + ".eps"
writeFilePrev = writeFilePass + "_repData_v2" + split_readFile[0][2] + ".png"
...
#table_data = [['Left rail', 'Right rail', 'Signal bond'], ['Point N', 'Point F']]
# 表のデータを修正
table_data = [['-', '-', '-'], ['-', '-', '-']]
...
# 表のレイアウトを設定
table = plt.table(cellText=table_data, cellLoc='center', loc='top', colLabels=col_labels, rowLabels=row_labels)
