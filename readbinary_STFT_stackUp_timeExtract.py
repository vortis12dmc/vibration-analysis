...
writeFile = readFile1_1[:-4] + "_STFT_stackUp_timeTrim"+str(start_time)+"-"+str(end_time)+".eps"
pngWriteFile = readFile1_1[:-4] + "_STFT_stackUp_timeTrim"+str(start_time)+"-"+str(end_time)+".png"
...
#スペクトログラムのプロット
ax_sp1.set_xlim(start_time, end_time)
