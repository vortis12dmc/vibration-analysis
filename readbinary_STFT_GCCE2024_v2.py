...
fftAxis = "STFT " + sprit_readFile[2] + "/N_Left_Rail/" + axis + "-axis"

thre=int(threshold_val/10)
propaties = axis+"-axis_thre"+str(thre)+"G"
writeFile = readFile1_1[:-4] + "_STFT_GCCE2024_v2.eps"
writeFilePrev = readFile1_1[:-4] + "_STFT_GCCE2024_v2.png"
...
#ax_sp1 = fig.add_axes([0.17, 0.15, 0.7, 0.7])
#cb_sp1 = fig.add_axes([0.87, 0.15, 0.02, 0.7])

ax_sp1 = fig.add_axes([0.12, 0.12, 0.75, 0.75])
cb_sp1 = fig.add_axes([0.89, 0.12, 0.02, 0.75])
