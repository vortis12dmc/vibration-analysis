...
writeFile = readFile1_1[:-4] + "_STFT_GCCE2024.eps"
writeFilePrev = readFile1_1[:-4] + "_STFT_GCCE2024.png"
...
ax_sp1 = fig.add_axes([0.15, 0.15, 0.7, 0.7])
cb_sp1 = fig.add_axes([0.85, 0.15, 0.02, 0.7])
